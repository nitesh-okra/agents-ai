...
const BASE = process.env.Agents_E2E_BASE_URL ?? "http://127.0.0.1:3105";
const DATA_DIR = process.env.Agents_E2E_DATA_DIR ?? process.env.Agents_HOME;
const CONFIG_PATH = process.env.Agents_E2E_CONFIG_PATH ?? path.resolve(process.cwd(), ".Agents/config.json");
