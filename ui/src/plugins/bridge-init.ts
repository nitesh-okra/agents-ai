 ...
 *
 * This is placed on `globalThis.__AgentsPluginBridge__` and consumed by
...
declare global {
  ...
  var __AgentsPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__AgentsPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__AgentsPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
